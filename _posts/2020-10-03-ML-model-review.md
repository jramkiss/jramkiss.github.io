...
<!-- Other topics:
- Convolutional Neural Networks: http://d2l.ai/chapter_convolutional-neural-networks/index.html
- Regularization: http://cs229.stanford.edu/notes/cs229-notes5.pdf
- Gradient Boosting: http://cs229.stanford.edu/notes/cs229-notes-ensemble.pdf
- Dropout
- Batch Normalization
- Residual and Dense Connections
- Attention
- EM algorithm: http://cs229.stanford.edu/notes/cs229-notes8.pdf
- Factor analysis: http://cs229.stanford.edu/notes/cs229-notes9.pdf
 -->